...
<head>
  ...
  <link rel="stylesheet" href="css/recommend_menu.css">
</head>
<body>
  <div class="container">
    <div class="top-bar">
    ...
    <div class="content-wrapper">
      <div class="menu-section">
        ...
        <div class="category-bar">
          <a href="recommend_menu.php" class="menu-category-item active">
        ...
        <div class="tags">
           <div class="tag rec">⭐ เมนูแนะนำ</div>
           <a href="home_customer.php" class="tag popular">⭐ เมนูยอดนิยม</a>
           <a href="promotionpage.php" class="tag promo">⭐ โปรโมชั่น </a>
        </div>
        <div class="menu-grid">
          <div class="menu-card">
            <img src="pics/recommend1.png" class="menu-img" data-img="pics/recommend1.png">
            <div class="menu-name">แกงมัสมั่นไก่</div>
            <div class="menu-price">฿ 75</div>
            <button class="select-btn">เลือก</button>
          </div>
          <div class="menu-card">
            <img src="pics/recommend2.png" class="menu-img" data-img="pics/recommend2.png">
            <div class="menu-name">ผัดไทยกุ้งสด</div>
            <div class="menu-price">฿ 60</div>
            <button class="select-btn">เลือก</button>
          </div>
          <div class="menu-card">
            <img src="pics/recommend3.png" class="menu-img" data-img="pics/recommend3.png">
            <div class="menu-name">ต้มข่าไก่</div>
    ...
    function updateCartDisplay() {
      ...
      for (const itemName in selectedMenuItems) {
        if (selectedMenuItems.hasOwnProperty(itemName) && selectedMenuItems[itemName].quantity > 0) {
          ...
          let description = "";
          switch (itemName) {
            case "แกงมัสมั่นไก่": description = "แกงมัสมั่นไก่ ใส่ตะไคร้"; break;
            case "ผัดไทยกุ้งสด": description = "ผัดไทยกุ้ง เส้นเหนี่ยวนุ่ม กุ้งแม่นํ้า"; break;
            case "ต้มข่าไก่": description = "ต้มข่าไก่ กลิ่นเครื่องเทศหอมฟุ้ง"; break;
            default: description = "";
          }
