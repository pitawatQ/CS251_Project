        ...
        <div class="content-wrapper">
            <div class="menu-section">
                ...
                <div class="category-bar">
                    ...
                    <a href="friedfood_menu.php" class="menu-category-item active" data-category="ของทอด">
                        <img src="pics/friedfood.png" alt="ของทอด">
                        <div class="label">ของทอด</div>
                    </a>
                    <a href="bev_menu.php" class="menu-category-item" data-category="เครื่องดื่ม">
                ...
                <div class="menu-grid">
                    <div class="menu-card" data-item-id="1" data-category="ข้าวต้ม">
                        <img src="img/menu/firedchicken.jpg" class="menu-img" data-img="img/menu/firedchicken.jpg">
                        <div class="menu-name">ไก่ทอด</div>
